namespace Registration.Components.Consumers
{
        ...
        IConsumer<SubmitRegistration>
    {
        ...
        {
            _logger.LogInformation("Registration received: {0} ({1})", context.Message.SubmissionId, context.Message.ParticipantEmailAddress);
            ...
            _logger.LogInformation("Registration accepted: {0} ({1})", context.Message.SubmissionId, context.Message.ParticipantEmailAddress);
        }
